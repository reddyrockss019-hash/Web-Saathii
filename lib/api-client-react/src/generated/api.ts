...
export const generateWebsite = async (
  generateWebsiteRequest: GenerateWebsiteRequest,
  options?: RequestInit,
  ...
  return customFetch<GenerateWebsiteResponse>(getGenerateWebsiteUrl(), {
    ...
    body: JSON.stringify(generateWebsiteRequest),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<GenerateWebsiteRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type GenerateWebsiteMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateWebsite>>
>;
export type GenerateWebsiteMutationBody = BodyType<GenerateWebsiteRequest>;
export type GenerateWebsiteMutationError = ErrorType<ErrorEnvelope>;
